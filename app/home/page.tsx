        ...
        <div className="mx-auto max-w-md px-6 py-8">
          ...
          <div className="mb-8 grid grid-cols-3 gap-3">
            ...
            <div className="rounded-2xl bg-white p-4 shadow-sm border border-gray-50">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats ? (stats.unsorted.liked + Object.values(stats.folders || {}).reduce((sum, f) => sum + f.liked, 0)) : 0}</p>
