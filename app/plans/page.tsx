...
import { getAllPlans, type Plan } from "@/lib/db";
      ...
      <div className="mx-auto max-w-md px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <button 
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-black shadow-lg hover:scale-105 transition-all active:scale-95"
            >
              <svg
        ...
        {isLoading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="mb-6 text-sm text-gray-500">Create your first content plan to get started</p>
            <button
              onClick={() => router.push("/upload")}
          ...
          <div className="space-y-4">
            {plans.map((plan) => (
              <div
                ...
                className="overflow-hidden rounded-[32px] bg-white border border-gray-50 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer"
              >
                <div className="p-6">
                  {/* Plan Header */}
